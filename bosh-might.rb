...
ssh_command "wget https://github.com/cloudfoundry-incubator/spiff/releases/download/v1.0.3/spiff_linux_amd64.zip -P ~/workspace/"
...
ssh_command "sudo chown ubuntu:ubuntu /home/ubuntu/.bosh_config"
ssh_command "sudo chown ubuntu:ubuntu /home/ubuntu/tmp"
